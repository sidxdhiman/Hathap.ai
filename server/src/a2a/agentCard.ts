...
export function buildAgentCard(baseUrl: string): AgentCard {
  ...
  return {
    ...
    description:
      'Multi-agent AI debate platform. Submit a topic or courtroom ID to orchestrate structured debates between AI personas and receive a synthesized verdict.',
    ...
    skills: [
      {
        ...
        name: 'Run Debate',
        description:
          'Run a multi-agent debate on a topic. Send plain text (the objective) or JSON with objective, mode, agentIds, and optional courtroomId.',
