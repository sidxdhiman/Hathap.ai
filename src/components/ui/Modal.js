...
export const Modal = ({ isOpen, onClose, title, children, size = 'md', }) => {
    ...
    return (_jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center", children: [_jsx("div", { className: "absolute inset-0 bg-black/60 backdrop-blur-sm", onClick: onClose }), _jsxs("div", { className: `relative border shadow-2xl rounded-[8px] ${sizeClasses[size]} w-full mx-4`, style: {
