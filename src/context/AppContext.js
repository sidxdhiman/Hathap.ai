...
export const AppProvider = ({ children }) => {
    ...
    const refreshData = async () => {
        try {
            ...
            setModels(Array.isArray(mRes) ? mRes.map((m) => ({ ...m, id: m._id })) : []);
            setAgentTemplates(Array.isArray(aRes) ? aRes.map((a) => ({ ...a, id: a._id })) : []);
            setCourtrooms(Array.isArray(cRes) ? cRes.map((c) => ({ ...c, id: c._id })) : []);
        }
        catch (e) {
    ...
    const updateAgentTemplate = (id, updates) => {
    ...
    const updateCourtroom = (id, updates) => {
